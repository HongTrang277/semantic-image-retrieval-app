    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
        <div class="p-8 md:p-10">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-extrabold text-slate-900 mb-2">Đăng ký tài khoản mới</h2>
                <p class="text-slate-500">Tham gia ngay để trải nghiệm tìm kiếm ảnh thông minh</p>
            </div>
            ...
            <div class="mt-6 text-center">
                <a href="loginPage.jsp" class="text-sm font-medium text-brand-600 hover:text-brand-500 hover:underline">
